(function () {
    ...
    function printLikedHomes() {
        ...
        for (let i = 0; i < 4; i++) {
            ...
            // hotelCard.addEventListener('click', printHotelsByDestination(currentElement, HOTEL_PAGE_CONTAINER));
        }
    }
    ...
    function printHotelsByDestination(searchInput, container) {
        ...
        filtered.forEach(currentElement => {
            ...
            hotelCard.addEventListener('click', printHotelPage);
